    ...
    <section className="my-32">
      ...
      <div className="flex flex-wrap">
        <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
          ...
          <button
            type="button"
            className="mb-6 inline-block w-full rounded bg-indigo-400 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500"
          >
            Send
          </button>
        </form>
